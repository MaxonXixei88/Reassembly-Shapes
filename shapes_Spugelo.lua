  -- THRUSTER (very thin)
  {100, {{verts={{0,-3.5}, {-1.5, -4.5}, {-1.5, 4.5}, {0, 3.5}}, ports={{0, 0.5, NONE}, {1, 0.5, THRUSTER_OUT}, {2, 0.5, NONE}, {3, 0.5, THRUSTER_IN}}},
  ...
  -- THRUSTER2
  {101, {{verts={{4.9, -3.5}, {-4.9,-4.9}, {-4.9, 4.9}, {4.9, 3.5}}, ports={{3, 0.5, THRUSTER_IN}, {1, 0.5, THRUSTER_OUT}}},
  ...
  -- THRUSTER3
  {102, {{verts={{0,-3.5}, {-1.5, -4.5}, {-1.5, 4.5}, {0, 3.5}}, ports={{0, 0.5, NONE}, {1, 0.5, THRUSTER_OUT}, {2, 0.5, NONE}, {3, 0.5, THRUSTER_IN}}},
		 {verts={{0,-7}, {-3, -9}, {-3, 9}, {0, 7}}, ports={{0, 0.5, NONE}, {1, 0.5, THRUSTER_OUT}, {2, 0.5, NONE}, {3, 0.5, THRUSTER_IN}}},
		 {verts={{0,-10.5}, {-4.5, -13.5}, {-4.5, 13.5}, {0, 10.5}}, ports={{0, 0.5, NONE}, {1, 0.5, THRUSTER_OUT}, {2, 0.5, NONE}, {3, 0.5, THRUSTER_IN}}}}}

  -- SLOPE_SMALL_R 0.5x0.5, 0.5x1, 0.5x1.5
   {103, {{verts={{5, 0}, {0, 0}, {0, 5}}, ports={{0, 0.5}, {1, 0.5}, {2, 0.5}}},
  ...
  -- RECT_LONG_VERYTHIN (quarter)
   {105, {{verts={{10, 0}, {0, 0}, {0, 2.5}, {10, 2.5}}, ports={{0, 0.5}, {1, 0.5}, {2, 0.5}, {3, 0.5}}},
  ...
  -- MINIGUN_BASE (used for the weapon itself)
   {106, {{verts={{2.5, 3.5}, {7.5, 3.5}, {7.5, 1.5}, {2.5, 1.5}, {2.5, 0}, {-2.5, 0}, {-2.5, 5}, {2.5, 5}}, ports={{0, 0.5, NONE}, {1, 0.5, WEAPON_OUT}, {2, 0.5, NONE}, {3, 0.5}, {4, 0.5}, {5, 0.5}, {6, 0.5}, {7, 0.5}}},
  ...
  -- MINIGUN_EXTENSION (linked directly to the base of minigun)
   {107, {{verts={{0, 1.5}, {-5, 1.5}, {-5, 3.5}, {0, 3.5}, {0, 5}, {1.25, 5}, {1.25, 0}, {0, 0}}, ports={{0, 0.5, NONE}, {1, 0.5, WEAPON_IN}, {2, 0.5, NONE}, {3, 0.5}, {4, 0.5, NONE}, {5, 0.15}, {5, 0.5, WEAPON_OUT}, {5, 0.85}, {6, 0.5, NONE}, {7, 0.5}}},
  ...
  -- MINIGUN_BARREL (linked between extension and base)
   {108, {{verts={{5, 0}, {0, 0}, {0, 1}, {5, 1}}, ports={{0, 0.5, NONE}, {1, 0.5}, {2, 0.5, NONE}, {3, 0.5}}},
  ...
  -- MINIGUN_BARREL_SHORT (linked at the end of the extension to the center)
   {109, {{verts={{1.5, 0}, {0, 0}, {0, 1}, {1.5, 1}}, ports={{0, 0.5, NONE}, {1, 0.5, WEAPON_IN}, {2, 0.5, NONE}, {3, 0.5, WEAPON_OUT}}},
  ...
  -- MINIGUN_BARREL_SHORT_DECORATION (linked at the end of extension, edges)
   {110, {{verts={{1.5, 0}, {0, 0}, {0, 1}, {1.5, 1}}, ports={{0, 0.5, NONE}, {1, 0.5}, {2, 0.5, NONE}, {3, 0.5}}},
  ...
  -- MISSILE_LAUNCHER_DUAL (2 medium missiles)
   {111, {{verts={{7.5, 0}, {0, 0}, {0, 5}, {7.5, 5}}, ports={{0, 0.333}, {1, 0.5}, {2, 0.667}, {3, 0.25, LAUNCHER}, {3, 0.75, LAUNCHER}}},
  ...
  -- MISSILE_DUAL (medium missile for dual launcher)
   {112, {{verts={{5, 0}, {0, 0}, {0, 2}, {5, 2}, {7.5, 1}}, ports={{0, 0.5, NONE}, {1, 0.5, MISSILE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}}},
  ...
  -- MISSILE_LAUNCHER_SWARM (missiles: scale1: 3, scale2: 4, scale3: 6, scale4: 8, scale5: 12)
   {113, {{verts={{2.5, 0}, {0, 0}, {0, 5}, {2.5, 5}}, ports={{0, 0.5}, {1, 0.5}, {2, 0.5}, {3, 0.167, LAUNCHER}, {3, 0.50, LAUNCHER}, {3, 0.833, LAUNCHER}}},
  ...
  -- MISSILE_SWARM (very small missiles for swarm missile launcher)
   {114, {{verts={{2.5, 0}, {0, 0}, {0, 1.5}, {2.5, 1.5}, {3.5, 0.75}}, ports={{0, 0.5, NONE}, {1, 0.5, MISSILE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}}},
  ...
  -- MISSILE_LAUNCHER_CRUISE (bigger single missile launcher)
   {115, {{verts={{7.5, 0}, {0, 0}, {0, 5}, {7.5, 5}}, ports={{0, 0.333}, {1, 0.5}, {2, 0.667}, {3, 0.5, LAUNCHER}}},
  ...
  -- MISSILE_CRUISE (missile for cruise missile launcher)
   {16, {{verts={{6, 0}, {0, 0}, {0, 3}, {6, 3}, {9, 1.5}}, ports={{0, 0.5, NONE}, {1, 0.5, MISSILE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}}},
  ...
  -- TORPEDO_LAUNCHER (large, relatively slender but long missile launcher)
   {117, {{verts={{2.5, 0}, {0, 0}, {0, 4}, {2.5, 4}}, ports={{0, 0.5}, {1, 0.5}, {2, 0.5}, {3, 0.5, LAUNCHER}}},
  ...
  -- TORPEDO (missiles for torpedo launcher)
   {118, {{verts={{10, 0}, {0, 0}, {0, 3}, {10, 3}, {11.5, 2.25}, {12, 1.5}, {11.5, 0.75}}, ports={{0, 0.5, NONE}, {1, 0.5, MISSILE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}, {5, 0.5, NONE}, {6, 0.5, NONE}}},
  ...
  -- SPIKE
  {119, {{verts={{10, -1.25}, {-15, -1.25}, {-15, 1.25}, {10, 1.25}, {15, 0}}, ports={{0, 0.5, NONE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}, {1, 0.5}}},
  ...
  {120, {{verts={{10.1, -0.75}, {-10.1, -0.75}, {-10.1, 0.75}, {10.1, 0.75}, {10.1, 2}, {15, 0}, {10.1, -2}}, ports={{1, 0.5, MISSILE}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5, NONE}, {5, 0.5, NONE}, {6, 0.5, NONE}, {0, 0.5, NONE}}},
  ...
  {121, {{verts={{2, -3}, {-2, -3}, {-2, 3}, {2, 3}}, ports={{1, 0.5}, {2, 0.5}, {3, 0.167}, {3, 0.5, LAUNCHER}, {3, 0.833}, {0, 0.5}}},
         {verts={{4, -6}, {-4, -6}, {-4, 6}, {4, 6}}, ports={{1, 0.5}, {2, 0.5}, {3, 0.167}, {3, 0.5, LAUNCHER}, {3, 0.833}, {0, 0.5}}}}}
  -- CROSSBOW_BARREL (scale=2 Ballista)
  {122, {{verts={{1, -10}, {-1, -10}, {-1, 10}, {1, 10}}, ports={{1, 0.95}, {3, 0.05}, {0, 0.5}}},
         {verts={{2, -20}, {-2, -20}, {-2, 20}, {2, 20}}, ports={{1, 0.95}, {3, 0.05}, {0, 0.5}}}}}
  -- CROSSBOW_LIMB_R (scale=2 Ballista)
  {123, {{verts={{10, 0}, {0, 0}, {0, 2}, {11, 2}, {25, -12}, {20, -10}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5}, {5, 0.5, NONE}, {0, 0.5, NONE}}},
  ...
  {124, {{verts={{-11, 2}, {0, 2}, {0, 0}, {-10, 0}, {-20, -10}, {-25, -12}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5, NONE}, {4, 0.5}, {5, 0.5, NONE}, {0, 0.5, NONE}}},
  ...
  {125, {{verts={{22.75, -11.1}, {0, -20.25}, {0, -19.75}, {22.25, -10.9}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5}, {0, 0.5, NONE}}},
         {verts={{45.5, -22.2}, {0, -40.5}, {0, -39.5}, {44.5, -21.8}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5}, {0, 0.5, NONE}}}}}
  -- CROSSBOW_STRING_L (scale=2 Ballista)
  {126, {{verts={{0, -20.25}, {-22.75, -11.1}, {-22.25, -10.9}, {0, -19.75}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5}, {0, 0.5, NONE}}},
         {verts={{0, -40.5}, {-45.5, -22.2}, {-44.5, -21.8}, {0, -39.5}}, ports={{1, 0.5}, {2, 0.5, NONE}, {3, 0.5}, {0, 0.5, NONE}}}}}

  -- FLAMETHROWER_BASE
  {127, {{verts={{10,-2.5}, {-5, -5}, {-5, 5}, {10, 2.5}}, ports={{0, 0.5, NONE}, {1, 0.5}, {2, 0.5, NONE}, {3, 0.5, WEAPON_OUT}}},
  ...
  -- FLAMETHROWER_PIPE
  {128, {{verts={{15,-1.5}, {-15, -1.5}, {-15, 1.5}, {15, 1.5}}, ports={{0, 0.5, NONE}, {1, 0.5, WEAPON_IN}, {2, 0.5, NONE}, {3, 0.5, WEAPON_OUT}}},
  ...
  -- FLAMETHROWER_MUZZLE
  {129, {{verts={{3.5,-3}, {-3, -2.5}, {-3, 2.5}, {3.5, 3}}, ports={{0, 0.5, NONE}, {1, 0.5, WEAPON_IN}, {2, 0.5, NONE}, {3, 0.5, WEAPON_OUT}}},
